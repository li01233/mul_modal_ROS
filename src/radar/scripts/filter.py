...
def generate_map(r, k, p, K, area_threshold, gamma):
    ...
    P = extract_coastline(D, area_threshold=1, angular_resolution=None, K=None)
...
# spokes = np.random.randint(0, 128, (250, 256)).astype(np.uint8)
# generate_radar_image(spokes, None)
